...
class Token(object):
    ...
    Attributes:
        ...
        tokenizer generate also instance of this class. This functionality helps
        parsing some languages, though it just moves complexity from the parsing
        side to the tokenizer.
    """
    name = None
    pattern_str = r""
